全限定名：org.springframework.beans.factory.config.SmartInstantiationAwareBeanPostProcessor  
```text
BeanPostProcessor接口  
...
public class TestSmartInstantiationAwareBeanPostProcessor implements SmartInstantiationAwareBeanPostProcessor {
    ...
    //触发点：发生在postProcessBeforeInstantiation之前
    @Override
    ...
    //触发点：发生在postProcessBeforeInstantiation之后，实例化之前
    @Override
    ...
    //触发点：发生在postProcessAfterInstantiation之后，当发生循环依赖时，在回调方法中触发
    @Override
